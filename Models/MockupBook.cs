namespace Hania_s_Bookstore.Models
{
    public class MockupBook : IBook
    {
        ...
        public IEnumerable<Book> AllBooks => new List<Book>
        {
            ...
            CoverURL = "https://m.media-amazon.com/images/I/91tK5sU9oOL._SL1500_.jpg", IsBestseller = true, InStock = true},
            ...
            CoverURL = "https://m.media-amazon.com/images/W/MEDIAX_792452-T2/images/I/71Oh0IR0bML._SL1500_.jpg", IsBestseller = true, InStock = false},
            ...
            CoverURL = "https://m.media-amazon.com/images/I/41LjCFM1aXL.jpg", IsBestseller = false, InStock = true},
        };
